        ...
        <div style={{ color: 'white', maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '24px', paddingBottom: '80px' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '16px' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '8px' }}>
                                        ...
                                        <button onClick={() => setConfirmDeleteId(goal.id)} style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'rgba(255,255,255,0.05)', border: 'none', color: 'rgba(255,255,255,0.3)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }} title="Excluir Meta"><Trash2 size={16} /></button>
                                    </div>
                                </div>
                            </div>
            ...
            {confirmDeleteId !== null && (
                <ConfirmModal
                    ...
                    danger={true}
                    onConfirm={() => handleDeleteGoal(confirmDeleteId)}
